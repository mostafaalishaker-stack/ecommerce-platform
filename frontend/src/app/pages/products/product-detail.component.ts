    ...
    <div class="max-w-4xl mx-auto px-4 py-10">
      @if (product) {
        <div class="grid md:grid-cols-2 gap-10">
          <div class="h-80 bg-gradient-to-br from-indigo-100 to-cyan-100 rounded-2xl flex items-center justify-center text-7xl text-indigo-300">
          ...
          <div>
            ...
            <button (click)="addToCart()" class="mt-6 bg-indigo-600 text-white px-8 py-3 rounded-xl font-semibold hover:bg-indigo-700 transition" [disabled]="product.stock===0">
