      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @for (product of products; track product.id) {
          <div class="bg-white rounded-xl border overflow-hidden hover:shadow-lg transition group">
            <div class="h-56 bg-gradient-to-br from-indigo-100 to-cyan-100 flex items-center justify-center text-5xl text-indigo-300">
            ...
            <div class="p-5">
              ...
              <div class="flex items-center justify-between mt-4">
                ...
                <div class="flex gap-2">
                  <a [routerLink]="['/products', product.id]" class="text-sm text-indigo-600 hover:underline">Details</a>
                  <button (click)="addToCart(product)" class="text-sm bg-indigo-600 text-white px-3 py-1.5 rounded-lg hover:bg-indigo-700 transition" [disabled]="product.stock===0">
